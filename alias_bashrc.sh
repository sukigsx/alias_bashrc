...
echo ""
software="which git diff ping figlet xdotool wmctrl nano" #ponemos el foftware a instalar separado por espacion dentro de las comillas ( soft1 soft2 soft3 etc )
