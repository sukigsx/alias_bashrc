...
export NombreScript="alias_bashrc"
export DescripcionDelScript="herramienta para Crear/Modificar/Backups de tu alias"
export Correo=""
export Web=""
export version="1.1"
...
NombreScriptActualizar="alias_bashrc.sh" #contiene el nombre del script para poder actualizar desde github
DireccionGithub="https://github.com/sukigsx/alias_bashrc.git" #contiene la direccion de github para actualizar el script

#VARIABLES DE SOFTWARE NECESARIO
#which git diff ping figlet xdotool nano fzf
